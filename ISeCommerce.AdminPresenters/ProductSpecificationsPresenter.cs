...
{
    public class ProductSpecificationsPresenter : Presenter
    {
        IProductSpecificationsView _view;

        public ProductSpecificationsPresenter(IProductSpecificationsView view, ISessionProvider session)
            : base(view, session)
        {
            _view = base.GetView<IProductSpecificationsView>();
        ...
        void _view_OnItemSelected(object sender, IdeaSeedLinkButtonArgs e)
        {
            if (!string.IsNullOrEmpty(e.Name))
                _view.NavigateTo(SecurityContextManager.Current.CurrentURL + "/" + e.ID.ToString() + "/Details");
        }
        ...
        {
            _view.ViewTitle = "Specifications";
        }
        ...
        {
            _view.ResultSet = SecurityContextManager.Current.CurrentProduct.Specifications;

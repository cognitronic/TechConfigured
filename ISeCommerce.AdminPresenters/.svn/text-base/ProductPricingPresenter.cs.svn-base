...
{
    public class ProductPricingPresenter : Presenter
    {
        IProductPricingView _view;

        public ProductPricingPresenter(IProductPricingView view, ISessionProvider session)
            : base(view, session)
        {
            _view = base.GetView<IProductPricingView>();
        ...
        void SaveItem()
        {
            ...
            item.RetailPrice = _view.RetailPrice;
            item.SalePrice = _view.SalesPrice;
            item.ListPrice = _view.ListPrice;
            item.CostPrice = _view.CostPrice;

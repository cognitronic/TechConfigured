...
{
    public class OrderListPresenter : Presenter
    {
        IOrderListView _view;

        public OrderListPresenter(IOrderListView view, ISessionProvider session)
            : base(view, session)
        {
            _view = base.GetView<IOrderListView>();
        ...
        {
            _view.ResultSet = _view.OrderList();

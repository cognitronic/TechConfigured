...
{
    public class BannerListPresenter : Presenter
    {
        IBannerListView _view;

        public BannerListPresenter(IBannerListView view, ISessionProvider session)
            : base(view, session)
        {
            _view = base.GetView<IBannerListView>();
        ...
        {
            _view.ResultSet = new BannerImageServices().GetAll();

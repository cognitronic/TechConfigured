...
{
    public class ProductImagesPresenter : Presenter
    {
        IProductImagesView _view;

        public ProductImagesPresenter(IProductImagesView view, ISessionProvider session)
            : base(view, session)
        {
            _view = base.GetView<IProductImagesView>();
        ...
        {
            _view.ResultSet = SecurityContextManager.Current.CurrentProduct.Images;

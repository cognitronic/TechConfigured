...
{
    public class InfoPageRouteHandler : IRouteHandler, IRequiresSessionState
    {
        public string VirtualPath { get; set; }

        public string PagePath { get; set; }

        public InfoPageRouteHandler(string virtualPath, string pagePath)
        {
        ...
        IHttpHandler IRouteHandler.GetHttpHandler(RequestContext requestContext)
        {
            ...
            page = (System.Web.UI.Page)BuildManager.CreateInstanceFromVirtualPath(PagePath, typeof(System.Web.UI.Page));

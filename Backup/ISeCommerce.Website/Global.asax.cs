...
namespace ISeCommerce.Website
{
    public class Global : System.Web.HttpApplication
    {
        ...
        void Application_Start(object sender, EventArgs e)
        {
            ...
            Context.Cache.Insert(ResourceStrings.Cache_ApplicationSettings, new ApplicationSettingServices().GetByApplicationID(Convert.ToInt16(ConfigurationManager.AppSettings["APPLICATIONID"])));

...
<div class="secnd_navi">
    ...
    <ul class="network">
        <li>Share with us:</li>
        <li><a href="http://www.facebook.com/TechConfigured" target="_blank"><img src="/images/facebook.gif" alt="" /></a></li>
        <li><a href="http://www.twitter.com/TechConfigured" target="_blank"><img src="/images/twitter.gif" alt="" /></a></li>
    </ul>
</div>
<div class="clear"></div>
<div class="logo">

...
{
    [PresenterType(typeof(BannerListPresenter))]
    public partial class BannerListView : BaseWebUserControl, IBannerListView
    {
        ...
        public IList<BannerImage> ResultSet
        {
            get;
            set;
        }
        ...
        //#region IBannerListView Members

        //IList<BannerImage> BannerList()
        //{

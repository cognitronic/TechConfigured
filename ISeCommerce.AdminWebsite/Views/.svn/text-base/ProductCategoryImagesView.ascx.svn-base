<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductCategoryImagesView.ascx.cs" Inherits="ISeCommerce.AdminWebsite.Views.ProductCategoryImagesView" %>
            ...
            <Columns>
                ...
                DataField="ImageSizeTypeID">
                    ...
                    <EditItemTemplate>
                        ...
                        runat="server"
                        SelectedValue='<%# String.IsNullOrEmpty(Convert.ToString(DataBinder.Eval(Container.DataItem,"ImageSizeTypeID"))) ? "" : DataBinder.Eval(Container.DataItem,"ImageSizeTypeID") %>'
                        ID="ddlImageSizeType" />
                    </EditItemTemplate>
                    <ItemStyle VerticalAlign="Top" />
                </telerik:GridTemplateColumn>

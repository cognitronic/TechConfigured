...
using ISeCommerce.AdminWeb.Routing;
...
namespace ISeCommerce.AdminWebsite
{
    public class Global : System.Web.HttpApplication
    {
        ...
        void Application_Start(object sender, EventArgs e)
        {
            ...
            builder.Run();
            Context.Cache.Insert(ResourceStrings.Cache_AdminNavData, new PageServices().GetByNavigationType(PageNavigationType.ADMIN_PRIMARY));
